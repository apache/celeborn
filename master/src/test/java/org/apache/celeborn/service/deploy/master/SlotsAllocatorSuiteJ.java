...
public class SlotsAllocatorSuiteJ {
  private List<WorkerInfo> prepareWorkers(boolean hasDisks) {
    ...
    workers.add(new WorkerInfo("host1", 9, 10, 110, 113, 116, 117, 122, 123, disks1, null));
    workers.add(new WorkerInfo("host2", 9, 11, 111, 114, 118, 119, 124, 125, disks2, null));
    workers.add(new WorkerInfo("host3", 9, 12, 112, 115, 120, 121, 126, 127, disks3, null));
    return workers;
  }
