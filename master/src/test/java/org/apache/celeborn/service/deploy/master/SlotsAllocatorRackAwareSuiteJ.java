...
public class SlotsAllocatorRackAwareSuiteJ {
  ...
  private List<WorkerInfo> prepareWorkers(CelebornRackResolver resolver) {
    ...
    workers.add(
        new WorkerInfo("host1", 9, 10, 110, 113, 212, 312, 412, 512, new HashMap<>(), null));
    workers.add(
        new WorkerInfo("host2", 9, 11, 111, 114, 212, 312, 412, 512, new HashMap<>(), null));
    workers.add(
        new WorkerInfo("host3", 9, 12, 112, 115, 212, 312, 412, 512, new HashMap<>(), null));
    workers.add(
        new WorkerInfo("host4", 9, 10, 110, 113, 212, 312, 412, 512, new HashMap<>(), null));
    workers.add(
        new WorkerInfo("host5", 9, 11, 111, 114, 212, 312, 412, 512, new HashMap<>(), null));
    workers.add(
        new WorkerInfo("host6", 9, 12, 112, 115, 212, 312, 412, 512, new HashMap<>(), null));
  ...
  private static class WorkersSupplier implements Supplier<List<WorkerInfo>> {
    ...
    private static WorkerInfo initWorker(String host, String rack) {
      ...
      WorkerInfo workerInfo =
          new WorkerInfo(
              host, 1, 2, 3, 4, 5, 6, 7, 8, Collections.unmodifiableMap(diskInfoMap), null);
