...
class AppDiskUsageMetricSuite extends AnyFunSuite
  ...
  with Logging {
  val WORKER1 = new WorkerInfo("host1", 111, 112, 113, 114, 115, 116, 117, 118)
  val WORKER2 = new WorkerInfo("host2", 211, 212, 213, 214, 215, 216, 217, 218)
  val WORKER3 = new WorkerInfo("host3", 311, 312, 313, 314, 315, 316, 317, 318)
