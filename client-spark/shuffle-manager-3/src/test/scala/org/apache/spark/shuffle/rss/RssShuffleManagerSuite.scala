...
class RssShuffleManagerSuite extends Logging {
  ...
  def testFallBack(): Unit = {
    val conf = new SparkConf().setIfMissing("spark.master", "local")
      .setIfMissing("spark.shuffle.manager", "org.apache.spark.shuffle.rss.RssShuffleManager")
      .set("spark.rss.master.address", "localhost:9097")
      .set("spark.shuffle.service.enabled", "false")
      .set("spark.shuffle.useOldFetchProtocol", "true")
      .set("spark.rss.push.data.replicate", "false")
