...
class WorkerSuite extends AnyFunSuite with BeforeAndAfterEach {
  ...
  test("clean up") {
    ...
    val pl1 =
      new PartitionLocation(0, 0, "12", 0, 0, 0, 0, 0, 0, 0, 0, PartitionLocation.Mode.PRIMARY)
    val pl2 =
      new PartitionLocation(1, 0, "12", 0, 0, 0, 0, 0, 0, 0, 0, PartitionLocation.Mode.REPLICA)
