...
|   spark.rss.client.compression.mode     |   LZ4   |                                                                                                                  Compression and decompression mode used by RSS shuffle data.                                                                                                                 |
| spark.rss.client.compression.zstd.level |    1    |                                The compression degree of ZSTD, the value is limited to a positive integer between 1-22. The lower the level, the faster the speed,thus there is a trade-off between the compression ratio and the compression speed.                                          |
