...
```properties
# Shuffle manager class name Change from org.apache.spark.shuffle.celeborn.RssShuffleManager to org.apache.spark.shuffle.celeborn.SparkShuffleManager after 0.3.0 version.
