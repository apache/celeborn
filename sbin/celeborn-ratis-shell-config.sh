...
CELEBORN_RATIS_SHELL_JAVA_OPTS+=" -Dratis.shell.conf.dir=${CELEBORN_CONF_DIR} -Dratis.shell.logs.dir=${CELEBORN_LOG_DIR} -Dratis.shell.user.logs.dir=${RATIS_SHELL_USER_LOGS_DIR}"
