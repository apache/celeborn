...
call "%CELEBORN_HOME%\sbin\celeborn-daemon.cmd" start org.apache.celeborn.service.deploy.worker.Worker %WORKER_INSTANCE% %*

echo "Failed to start Celeborn worker"
exit /b 1
