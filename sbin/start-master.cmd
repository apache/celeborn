...
if not defined CELEBORN_MASTER_MEMORY (
    set CELEBORN_MASTER_MEMORY=4g
)

set "CELEBORN_JAVA_OPTS=%CELEBORN_MASTER_JAVA_OPTS%"
set "CELEBORN_JAVA_OPTS=%CELEBORN_JAVA_OPTS% -Xmx%CELEBORN_MASTER_MEMORY%"
