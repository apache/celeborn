...
package org.apache.celeborn.client.api.v1;

import org.apache.celeborn.client.api.ApiClient;
import org.apache.celeborn.client.api.ApiException;
import org.apache.celeborn.client.api.ApiResponse;
import org.apache.celeborn.client.api.Pair;
...
public class DefaultApi {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<OperationStatusResponseBody>(
          ...
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<OperationStatusResponseBody>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  public ApiResponse<OperationStatusResponseBody> closeOperationWithHttpInfo(UUID sessionHandle, UUID operationHandle) throws ApiException {
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("closeOperation", localVarResponse);
        }
        return new ApiResponse<OperationStatusResponseBody>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<CloseSessionResponseBody>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<CloseSessionResponseBody>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  public ApiResponse<ExecuteStatementResponseBody> executeStatementWithHttpInfo(UUID sessionHandle, ExecuteStatementRequestBody executeStatementRequestBody) throws ApiException {
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("executeStatement", localVarResponse);
        }
        return new ApiResponse<ExecuteStatementResponseBody>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<ExecuteStatementResponseBody>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  public ApiResponse<FetchResultsResponseBody> fetchResultsWithHttpInfo(UUID sessionHandle, UUID operationHandle, Long token) throws ApiException {
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("fetchResults", localVarResponse);
        }
        return new ApiResponse<FetchResultsResponseBody>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<FetchResultsResponseBody>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<GetApiVersionResponseBody>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<GetApiVersionResponseBody>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<GetInfoResponseBody>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<GetInfoResponseBody>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  public ApiResponse<GetSessionConfigResponseBody> getSessionConfigWithHttpInfo(UUID sessionHandle) throws ApiException {
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getSessionConfig", localVarResponse);
        }
        return new ApiResponse<GetSessionConfigResponseBody>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<GetSessionConfigResponseBody>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<OpenSessionResponseBody>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<OpenSessionResponseBody>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  public ApiResponse<Void> triggerSessionWithHttpInfo(SessionHandle sessionHandle) throws ApiException {
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("triggerSession", localVarResponse);
        }
