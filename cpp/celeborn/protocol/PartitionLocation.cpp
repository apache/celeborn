...
std::string toString(StatusCode code) {
  switch (code) {
    ...
    case REPLICA_PARTITION_NOT_FOUND:
    ...
    case REPLICATE_DATA_FAILED:
      return "REPLICATE_DATA_FAILED";
    case NUM_MAPPER_ZERO:
      return "NUM_MAPPER_ZERO";
    case MAP_ENDED:
      return "MAP_ENDED";
    case STAGE_ENDED:
      return "STAGE_ENDED";
    case PUSH_DATA_FAIL_NON_CRITICAL_CAUSE:
      // Matches the Java enum name (PUSH_DATA_FAIL_NON_CRITICAL_CAUSE_PRIMARY),
      // both map to wire value 17.
      return "PUSH_DATA_FAIL_NON_CRITICAL_CAUSE_PRIMARY";
    case PUSH_DATA_WRITE_FAIL_REPLICA:
      return "PUSH_DATA_WRITE_FAIL_REPLICA";
    case PUSH_DATA_WRITE_FAIL_PRIMARY:
      return "PUSH_DATA_WRITE_FAIL_PRIMARY";
    case PUSH_DATA_FAIL_PARTITION_NOT_FOUND:
