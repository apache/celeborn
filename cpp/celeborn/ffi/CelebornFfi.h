...
celeborn_ffi_status celeborn_ffi_setup_lifecycle_manager(
    ...
    const char* host, size_t host_len, int32_t port,
    char** err_out);
...
celeborn_ffi_status celeborn_ffi_push_data(
    celeborn_ffi_handle* handle,
    int32_t shuffle_id, int32_t map_id, int32_t attempt_id, int32_t partition_id,
...
celeborn_ffi_status celeborn_ffi_mapper_end(
    celeborn_ffi_handle* handle,
    int32_t shuffle_id, int32_t map_id, int32_t attempt_id, int32_t num_mappers,
    char** err_out);
...
celeborn_ffi_status celeborn_ffi_read_partition_full(
    celeborn_ffi_handle* handle,
    int32_t shuffle_id, int32_t partition_id, int32_t attempt_number,
    int32_t start_map_index, int32_t end_map_index,
