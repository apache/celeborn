...
import static org.apache.celeborn.plugin.flink.TestUtils.createJobShuffleContext;
...
public class RemoteShuffleMasterSuiteJ {
  ...
  public void testShuffleMemoryAnnouncing() {
    ...
    MemorySize calculated =
        remoteShuffleMaster.computeShuffleMemorySizeForTask(
            CelebornFlinkShim.createTaskInputsOutputsDescriptor(
                3,
  ...
  public PartitionDescriptor createPartitionDescriptor(
    ...
    return CelebornFlinkShim.createPartitionDescriptor(intermediateDataSetId, partitionNum);
  }
