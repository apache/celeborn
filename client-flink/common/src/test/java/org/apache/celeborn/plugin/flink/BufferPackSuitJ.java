...
public class BufferPackSuitJ {
  ...
  public void testPackEmptyBuffers() throws Exception {
    ...
    BufferPacker.BiConsumerWithException<ByteBuf, BufferHeader, InterruptedException> ripeBufferHandler =
            (ripe, header) -> {
  ...
  public void testPartialBuffersForSameSubIdx() throws Exception {
    ...
    BufferPacker.BiConsumerWithException<ByteBuf, BufferHeader, InterruptedException> ripeBufferHandler =
            (ripe, header) -> output.add(Pair.of(ripe, header.getSubPartitionId()));
    BufferPacker packer = new BufferPacker(ripeBufferHandler);
  ...
  public void testPackMultipleBuffers() throws Exception {
    ...
    setDataType(buffers, EVENT_BUFFER, DATA_BUFFER, DATA_BUFFER, EVENT_BUFFER, DATA_BUFFER, DATA_BUFFER, EVENT_BUFFER);
    ...
    checkDataType(unpacked,  EVENT_BUFFER, DATA_BUFFER, DATA_BUFFER, EVENT_BUFFER, DATA_BUFFER, DATA_BUFFER, EVENT_BUFFER);
