...
public class RemoteShuffleResultPartition extends ResultPartition {
  ...
  private final ResultPartitionBytesCounter delegateResultPartitionBytes;
  ...
  public RemoteShuffleResultPartition(
    ...
    this.delegateResultPartitionBytes = CelebornFlinkShim.createResultPartitionBytesCounter(this);
  }
  ...
  public void updateStatistics(BufferWithSubpartition bufferWithSubpartition, boolean isBroadcast) {
    ...
    delegateResultPartitionBytes.update(bufferWithSubpartition, isBroadcast, readableBytes);
