...
public class CelebornTierMasterAgent implements TierMasterAgent {
    ...
    public void releasePartition(TierShuffleDescriptor shuffleDescriptor) {
        checkState(shuffleDescriptor instanceof RemoteShuffleDescriptor);
        try {
    ...
    private JobShuffleContext getJobShuffleContext(JobID jobID, TierShuffleHandler tierShuffleHandler) {
