...
public class ShuffleClientImpl extends ShuffleClient {
  ...
  public int pushOrMergeData(
    ...
    final byte[] body = new byte[PushDataHeaderUtils.BATCH_HEADER_SIZE + length];
    PushDataHeaderUtils.buildDataHeader(body, mapId, attemptId, nextBatchId, length);
    System.arraycopy(data, offset, body, PushDataHeaderUtils.BATCH_HEADER_SIZE, length);
