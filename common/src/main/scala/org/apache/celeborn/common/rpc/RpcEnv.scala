...
import org.apache.celeborn.common.rpc.RpcContext
...
object RpcEnv {
  ...
  def create(
      ...
      port: Int,
      conf: CelebornConf,
      securityContext: Option[RpcContext]): RpcEnv = {
  ...
  def create(
      ...
      conf: CelebornConf,
      numUsableCores: Int,
      securityContext: Option[RpcContext] = None): RpcEnv = {
    val config =
...
private[celeborn] case class RpcEnvConfig(
    ...
    port: Int,
    numUsableCores: Int,
    securityContext: Option[RpcContext])
