...
package com.aliyun.emr.rss.common.internal.config
...
import com.aliyun.emr.rss.common.network.util.{ByteUnit, JavaUtils}
...
case class ConfigBuilder(key: String) {
  ...
  def fallbackConf[T](fallback: ConfigEntry[T]): ConfigEntry[T] = {
    val entry = new FallbackConfigEntry(
      key,
      _prependedKey,
      _prependSeparator,
      _alternatives,
