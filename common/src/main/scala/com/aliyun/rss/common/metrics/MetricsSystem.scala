...
package com.aliyun.rss.common.metrics
...
import com.aliyun.rss.common.metrics.sink.{PrometheusHttpRequestHandler, PrometheusServlet, Sink}
import com.aliyun.rss.common.metrics.source.Source
...
object MetricsSystem {
  ...
  val SOURCE_REGEX: Regex = "^com.aliyun.rss.common.metrics.source\\.(.+)\\.(.+)".r
