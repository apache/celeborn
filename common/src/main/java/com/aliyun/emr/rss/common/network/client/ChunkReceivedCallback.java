 ...
 * made.
 *
 * <p>Note that if a general stream failure occurs, all outstanding chunk requests may be failed.
 */
public interface ChunkReceivedCallback {
  /**
   * Called upon receipt of a particular chunk.
   *
   * <p>The given buffer will initially have a refcount of 1, but will be release()'d as soon as
   ...
   * failure to fetch a prior chunk in this stream.
   *
