...
import com.aliyun.emr.rss.common.network.TestUtils;
...
public class NettyMemoryMetricsSuiteJ {
  ...
  private void setUp(boolean enableVerboseMetrics) {
    ...
    configMap.put("rss.shuffle.io.enableVerboseMetrics", String.valueOf(enableVerboseMetrics));
