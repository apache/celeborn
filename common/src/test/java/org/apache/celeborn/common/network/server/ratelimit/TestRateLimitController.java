...
public class TestRateLimitController {
  ...
  public void initialize() {
    RateLimitController.initialize(3, 10, 5, 1000, 1000);
  }
  ...
  public void testSingleUser() {
    RateLimitController controller = RateLimitController.instance();
    ...
    controller.incrementBytes(userIdentifier, 11);
    Assert.assertTrue(controller.isUserCongested(userIdentifier));

    controller.decrementBytes(userIdentifier, 11);
    Assert.assertFalse(controller.isUserCongested(userIdentifier));
  }
}
