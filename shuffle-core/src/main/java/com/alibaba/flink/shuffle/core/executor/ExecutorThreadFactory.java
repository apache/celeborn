 ...
 * thread pools that support remote shuffle service core coordination and processing work, and which
 ...
 *
 * <p>This class is copied from Apache Flink (org.apache.flink.runtime.util.ExecutorThreadFactory).
 */
public class ExecutorThreadFactory implements ThreadFactory {

    /** The thread pool name used when no explicit pool name has been specified. */
    private static final String DEFAULT_POOL_NAME = "shuffle-executor-pool";
    ...
    ExecutorThreadFactory(
        ...
        this.namePrefix = CommonUtils.checkNotNull(poolName) + "-thread-";
