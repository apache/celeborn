...
| celeborn.client.spark.push.writer.modeByPartitionCount.enable | false | Whether to enable push writer mode by partition count. If true, Celeborn will use sort-based shuffle writer when shuffle partition count is greater than or equal to `celeborn.client.spark.push.writer.modeByPartitionCount.threshold`. | 0.3.0 | 
| celeborn.client.spark.push.writer.modeByPartitionCount.threshold | 2000 | Threshold of shuffle partition count for push writer mode by partition count. | 0.3.0 | 
