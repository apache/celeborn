...
| celeborn.client.flink.shuffle.partitionSplit.enabled | false | whether to enable shuffle partition split. Old client don't support split compelely, so this value can be set true for new client. | 0.3.1 | 
