...
| celeborn.client.spark.push.sort.memory.adaptiveThreshold | false | false | adaptively adjust threshold for sort shuffle writer's memory threshold | 0.5.0 | celeborn.push.sortMemory.adaptiveThreshold | 
