...
| celeborn.push.unsafeRow.fastWrite | true | This is Celeborn's optimization on unsafeRow for Spark and it's true by default. If you have changed UnsafeRow's memory layout set this to false. | 0.2.2 | 
