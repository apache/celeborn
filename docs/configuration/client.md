...
| celeborn.master.availableWorker.cache.concurrencyLevel | 32 | false | The number of write locks to update availableWorker cache. | 0.3.0 | celeborn.availableWorker.cache.concurrencyLevel | 
| celeborn.master.availableWorker.cache.expireTime | 15s | false | The time before a cache item is removed. | 0.3.0 | celeborn.availableWorker.cache.expireTime | 
| celeborn.master.availableWorker.cache.size | 256 | false | The max cache items count for available worker cache. | 0.3.0 | celeborn.availableWorker.cache.size | 
| celeborn.master.availableWorker.shared.threads | 16 | false | Number of shared availableWorker threads in Master. | 0.3.2 |  | 
