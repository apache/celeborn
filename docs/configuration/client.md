...
| celeborn.client.slot.assign.maxWorkers | 1024 | Max workers that slots of one shuffle can be allocated on. Client side configuration will overwrite Master side configuration. | 0.3.1 | 
