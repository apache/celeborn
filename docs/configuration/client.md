...
| celeborn.client.spark.shuffle.fallback.enabled | true | false | When false, job failed immediately instead of trying to fall back to Spark's default shuffle. | 0.5.0 |  | 
