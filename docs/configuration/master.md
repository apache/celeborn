...
| celeborn.worker.estimatedPartitionSize.update.initialDelay | 5m | Initial delay time before start updating estimated partition size. | 0.2.0 | 
| celeborn.worker.estimatedPartitionSize.update.interval | 10m | Interval of updating estimated partition size. | 0.2.0 | 
