...
| celeborn.master.slot.assign.shuffleAvailableWorkers | false | false | Whether to shuffle the available workers before selecting to randomize the order for rack awareness during slot assign. | 0.6.0 |  | 
