...
| celeborn.master.slot.assign.loadAware.diskCountWeight | 1 | false | Weight of number of disks per group when calculating allocation ratio in load-aware assignment strategy | 0.7.0 | celeborn.slots.assign.loadAware.diskCountWeight | 
