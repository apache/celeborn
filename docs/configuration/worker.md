...
| celeborn.worker.directMemoryRatioForMemoryFileStorage | 0.0 | false | Max ratio of direct memory to store shuffle data. | 0.4.1 |  | 
...
| celeborn.worker.memoryFileStorage.maxFileSize | 8MB | Max size for a memory storage file. It must be lesser than 2GB. | 0.4.1 |  | 
