...
| celeborn.partitionSorter.directMemory.maxRatio | 0.1 | Max ratio of sort memory. | 0.2.0 | 
...
| celeborn.worker.pausePushData.directMemory.ratio | 0.85 | If direct memory usage reach this limit, worker will stop receive from executor. | 0.2.0 | 
| celeborn.worker.pauseReplicateData.directMemory.ratio | 0.95 | If direct memory usage reach  this limit, worker will stop receive from executor and other worker. | 0.2.0 | 
| celeborn.worker.replicate.threads | 64 | Thread number of worker to replicate shuffle data. | 0.2.0 | 
| celeborn.worker.resume.directMemory.ratio | 0.5 | If direct memory usage is less than this  limit, worker will resume receive. | 0.2.0 | 
