...
| celeborn.worker.sortPartition.indexCache.expire | 60s | PartitionSorter's cache item expire time. | 0.4.0 | 
| celeborn.worker.sortPartition.indexCache.size | 256 | PartitionSorter's cache size for index buffer. | 0.4.0 | 
