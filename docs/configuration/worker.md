...
| celeborn.worker.closeIdleConnections | false |  | 0.2.0 | 
...
| celeborn.worker.disks.check.timeout | 30s |  | 0.2.0 | 
| celeborn.worker.disks.checkFileClean.maxRetries | 3 |  | 0.2.0 | 
| celeborn.worker.disks.checkFileClean.timeout | 1000ms |  | 0.2.0 | 
| celeborn.worker.fetchserver.port | 0 |  | 0.2.0 | 
...
| celeborn.worker.noneEmptyDirExpireDuration | 1d |  | 0.2.0 | 
...
| celeborn.worker.pushServer.port | 0 |  | 0.2.0 | 
| celeborn.worker.register.timeout | 180s | Worker register timeout. | 0.2.0 | 
| celeborn.worker.replicate.fastfail.duration | 60s |  | 0.2.0 | 
| celeborn.worker.replicate.threads | 64 | Thread number of worker to replicate shuffle data. | 0.2.0 | 
| celeborn.worker.replicateserver.port | 0 |  | 0.2.0 | 
| celeborn.worker.rpc.port | 0 |  | 0.2.0 | 
...
| celeborn.worker.workingDirName | hadoop/rss-worker/shuffle_data |  | 0.2.0 | 
