...
| celeborn.worker.sortPartition.sortTimeLogThreshold | &lt;value of celeborn.worker.sortPartition.timeout&gt; | false | When sort time exceeds this threshold, log the file id and sort duration. Set to 0 to disable logging. | 0.6.1 |  | 
