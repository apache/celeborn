...
| celeborn.worker.directMemoryRatioToPauseReceive | 0.85 | If direct memory usage reaches this limit, worker will stop to receive from executor. | 0.2.0 | 
| celeborn.worker.directMemoryRatioToPauseReplicate | 0.95 | If direct memory usage reaches this limit, worker will stop to receive from executor and other worker. | 0.2.0 | 
...
| celeborn.worker.memory.checkInterval | 10ms | Worker direct memory checking interval. | 0.2.0 | 
| celeborn.worker.memory.reportInterval | 10s | Worker direct memory tracker reporting to log interval. | 0.2.0 | 
...
| celeborn.worker.partitionSorter.directMemoryRatioThreshold | 0.1 | Max ratio of sort memory. | 0.2.0 | 
