...
| celeborn.worker.writer.hdfs.createFile.maxRetries | 5 | false | Retry count for a index file writer to create if its creation was failed. | 0.7.0 |  |
| celeborn.worker.writer.hdfs.createFile.retryWait | 200ms | false | Wait interval after attempt to create index file or success file and then retry it. | 0.7.0 |  |
