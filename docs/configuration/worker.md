...
| celeborn.worker.writer.create.parallel.enabled | false | false | Whether to parallelize the creation of file writer. | 0.6.1 |  | 
| celeborn.worker.writer.create.parallel.threads | &lt;undefined&gt; | false | Thread number of worker to parallelize the creation of file writer. | 0.6.1 |  | 
| celeborn.worker.writer.create.parallel.timeout | 120s | false | Timeout for a worker to create a file writer in parallel. | 0.6.1 |  | 
