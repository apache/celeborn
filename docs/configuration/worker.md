...
| celeborn.shuffle.sortPartition.block.compactionFactor | 0.25 | Combine sorted shuffle blocks such that size of compacted shuffle block does not exceed compactionFactor * celeborn.shuffle.chunk.size | 0.4.2 |  | 
