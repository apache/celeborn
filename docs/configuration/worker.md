...
| celeborn.worker.decommission.check.interval | 30s | The wait interval of checking whether all the shuffle expired during worker decomission | 0.2.0 | 
| celeborn.worker.decommission.check.timeout | 3d | The wait time of waiting for all the shuffle expire during worker decommission. | 0.2.0 | 
