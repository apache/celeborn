...
| --- | ------- | --------- | ----------- | ----- | ---------- |
| celeborn.quota.app.diskBytesWritten | 9223372036854775807b | true | App level quota for written disk bytes. Only enforced when a higher-level quota (user/tenant/cluster) is already exceeded, to identify the app that should be throttled first. | 0.7.0 |  | 
| celeborn.quota.app.diskFileCount | 9223372036854775807 | true | App level quota for written disk file count. Only enforced when a higher-level quota (user/tenant/cluster) is already exceeded. | 0.7.0 |  | 
| celeborn.quota.app.hdfsBytesWritten | 9223372036854775807b | true | App level quota for written HDFS bytes. Only enforced when a higher-level quota (user/tenant/cluster) is already exceeded. | 0.7.0 |  | 
| celeborn.quota.app.hdfsFileCount | 9223372036854775807 | true | App level quota for written HDFS file count. Only enforced when a higher-level quota (user/tenant/cluster) is already exceeded. | 0.7.0 |  | 
