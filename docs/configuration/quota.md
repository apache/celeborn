...
| celeborn.quota.manager | org.apache.celeborn.service.deploy.master.quota.DefaultQuotaManager | QuotaManger class name. Default class is `org.apache.celeborn.service.deploy.master.quota.DefaultQuotaManager`. | 0.2.0 |  | 
<!--end-include-->
