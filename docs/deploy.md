...
# If your HDFS is enabled with Kerberos authentication. You also need to set the following
# parameters for Celeborn master and worker. You need to deploy the keytab file to the
