...
Celeborn release binary contains clients for Spark 3.x and Spark 4.x, copy the corresponding client jar into Spark's
`jars/` directory:
```shell
...
Celeborn release binary contains clients for Flink 1.18.x, Flink 1.19.x, Flink 1.20.x, Flink 2.0.x, Flink 2.1.x, Flink 2.2.x, Flink 2.3.x, copy the corresponding client jar into Flink's
`lib/` directory:
```shell
...
- Flink 1.19.x, Flink 1.20.x, Flink 2.0.x, Flink 2.1.x, Flink 2.2.x, Flink 2.3.x
```shell
cd $FLINK_HOME
vi conf/config.yaml
```
