...
Celeborn release binary contains clients for Flink 1.16.x, Flink 1.17.x, Flink 1.18.x, Flink 1.19.x, Flink 1.20.x, Flink 2.0.x and Flink 2.1.x, copy the corresponding client jar into Flink's
`lib/` directory:
```shell
...
- Flink 1.19.x, Flink 1.20.x, Flink 2.0.x, Flink 2.1.x
```shell
cd $FLINK_HOME
vi conf/config.yaml
```
