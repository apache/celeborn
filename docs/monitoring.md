...
These metrics are exposed by Celeborn master.
  ...
  - namespace=master
    ...
    | ManuallyExcludedWorkerCount  | The count of workers in manually excluded list.                                           |
    ...
    | RequestSlotsFailed           | The count of failed `RequestSlots` requests, labeled by the failure status code.           |
